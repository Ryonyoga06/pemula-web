export function RenderContent(){
  ...
  const homeDetails = {
    greetTxt: `Hello , I'm`,
    name: 'Ryon Yoga Ambara',
    profilePhoto: 'profile.jpg',
    welcomeTxt: 'Welcome to my personal website.',
    fbLink: 'https://www.facebook.com/ryonyoga.ambara?mibextid=ZbWKwL',
    tiktokLink: '',
    instagramLink: 'https://www.instagram.com/ryon_yoga06?igsh=eGlnOGp0NmtjNTVr',
    ytLink: ''
  }
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'profile.jpg',
    aboutMeFirstPrgrph: `Hi! I'm Ryon, a TikToker and programmer who loves sharing creative and inspiring work. I create content featuring my programming outputs, turning complex code into visually appealing and fun projects that resonate with my audience.`,
